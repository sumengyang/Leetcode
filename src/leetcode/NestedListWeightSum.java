...
public class NestedListWeightSum {
	...
	public void nestedListWeightSum(int[] num) {
 ...
 * NestedInteger { //@return true if this NestedInteger holds a single integer,
 * rather than a nested list. public boolean isInteger(); //@return the single
 * integer that this NestedInteger holds, if it holds a single integer // Return
